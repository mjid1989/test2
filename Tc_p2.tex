...
\begin{exercice}{}/
					...
					\begin{center}
					\fbox{\includegraphics[width=0.5\linewidth]{images/Tc/p2/im2.png}}\\
					\end{center}
					\begin{enumerate}[label=\protect\circled{\color{white}\textbf{\arabic*}}]
...
\begin{exercice}{}/
					...
					\begin{minipage}[c]{0.29\linewidth}
					\begin{center}
					\fbox{\includegraphics[width=0.9\linewidth]{images/Tc/p2/im1.png}}\\
					\end{center}
					\end{minipage}
					\end{enumerate}}
					\end{exercice}%=== source ===%
...
\begin{exercice}{}/
					...
					\begin{flushleft}
					\fbox{\includegraphics[width=0.9\linewidth]{images/Tc/p2/im3.png}}
					\end{flushleft}
					\end{minipage}
					\end{enumerate}
					نعطي : شدة الثقالة 
...
\begin{exercice}{}/
					...
					\begin{minipage}[c]{0.29\linewidth}
					\begin{center}
					\fbox{\includegraphics[width=0.9\linewidth]{images/Tc/p2/im4.png}}
					\end{center}
					\end{minipage}}
					\end{exercice}%=== source ===% 
  %Exercice 15
\begin{exercice}{}/
					...
					\begin{flushleft}
					\fbox{\includegraphics[width=0.8\linewidth]{images/Tc/p2/im5.png}}
					\end{flushleft}
					\end{minipage}
					\end{enumerate}
				نعطي :
...
\begin{exercice}{}/
					...
					\begin{minipage}[c]{0.34\linewidth}
					\begin{flushleft}
					\fbox{\includegraphics[width=0.9\linewidth]{images/Tc/p2/im6.png}}
					\end{flushleft}
					\end{minipage}
					\end{enumerate}}
					\end{exercice}%=== source ===%
...
\begin{exercice}{}/
					...
					\begin{minipage}[c]{0.64\linewidth}
					\begin{flushleft}
					\fbox{\includegraphics[width=0.9\linewidth]{images/Tc/p2/im7.png}}
					\end{flushleft}
					\end{minipage}
					\end{enumerate}}
					\end{exercice}%=== source ===%
...
\begin{exercice}{}/
					...
					$I_0$
					 ...
					 $\alpha$
					  مع الخط المنظمي.
					\begin{center}
					\fbox{\includegraphics[width=0.5\linewidth]{images/Tc/p2/im8.png}}\\
					\end{center}
					\begin{enumerate}[label=\protect\circled{\color{white}\textbf{\arabic*}}]
					\item 
					نعتبر المجموعة
...
\begin{exercice}{}/
					...
					\begin{minipage}[c]{0.24\linewidth}
					\begin{flushleft}
					\fbox{\includegraphics[width=0.6\linewidth]{images/Tc/p2/im9.png}}
					\end{flushleft}
					\end{minipage}}
					\end{exercice}%=== source ===%
  %Exercice 21
