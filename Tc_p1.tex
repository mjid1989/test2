\documentclass[12pt,a4paper]{article}
		...
		colback=yellow!10,colframe=black!50,boxrule=0.2mm,
		attach boxed title to top center={xshift=0cm,yshift=-3.7mm},
		fonttitle=\bfseries,varwidth boxed title=0.7\linewidth,
		colbacktitle=white!45!white,coltitle=white!10!black,colframe=red!50!black,
		interior style={top color=yellow!10,bottom color=yellow!10},
